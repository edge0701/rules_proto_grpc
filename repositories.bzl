...
VERSIONS = {
    ...
    "grpc_web_plugin_linux_arm64": {
        "type": "http_file",  # When updating, also update in package.json and vice-versa
        "urls": ["https://github.com/grpc/grpc-web/releases/download/1.4.1/protoc-gen-grpc-web-1.4.1-linux-aarch64"],
        "sha256": "71e05323b4da584ff3a0794f16548885766303c6e2f196f5cb5c329eea3e74fd",
        "executable": True,
    },
